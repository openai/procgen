...
extern std::vector<std::shared_ptr<QImage>> platform_easy_backgrounds;
...
extern std::vector<std::shared_ptr<QImage>> caterpillar_backgrounds;
extern std::vector<std::shared_ptr<QImage>> gemjourney_backgrounds;