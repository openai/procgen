...
const std::string NAME = "bossfight_move_200";
...
class BossfightMove200Game : public BasicAbstractGame {
  public:
...
REGISTER_GAME(NAME, BossfightMove200Game);
