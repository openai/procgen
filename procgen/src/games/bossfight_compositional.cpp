...
const std::string NAME = "bossfight_compositional";
...
class BossfightCompositionalGame : public BasicAbstractGame {
  public:
...
REGISTER_GAME(NAME, BossfightCompositionalGame);
