...
const std::string NAME = "bossfight_attack_400";
...
class BossfightAttack400Game : public BasicAbstractGame {
  public:
...
REGISTER_GAME(NAME, BossfightAttack400Game);
