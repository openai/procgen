...
const std::string NAME = "bossfight_attack_200";
...
class BossfightAttack200Game : public BasicAbstractGame {
  public:
...
REGISTER_GAME(NAME, BossfightAttack200Game);
